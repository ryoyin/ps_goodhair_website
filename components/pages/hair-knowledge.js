            ...
            <div className="content fda">
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-sm-8 description">醫學軟激光穿透表層細胞，到達毛囊根部，而毛囊根部含有豐富的黑色素，能夠強烈地吸收這個波長軟激光能量，令頭髮及毛囊保持健康生長，防止脫髮。</div>
                    </div>
                    <div className="row">
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-8 description">滲透獨家活養精華，提高毛囊養份，刺激毛囊生長，強化頭皮及頭髮健康。完成療程後，髮根變得強韌，脫髮情況大大減少，毛囊細胞及頭髮回復濃密健康，即時年輕。</div>
                    </div>
                </div>      
            </div>
